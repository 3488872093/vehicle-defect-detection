...
from ui.utils.AIChat import ChatDialog
...
class YOLOSHOWBASE:
        ...
        if widthSettingBox == 0:
            ...
            self.ui.mainbox.setStyleSheet("""
                                  QFrame#mainbox{
                                    ...
                                    border-radius:30%;
                                    background-color: qlineargradient(x1:0, y1:0, x2:1 , y2:0, stop:0 white, stop:0.2 white, stop:0.7 #3b3c50, stop:1 #3b3c50);
                                }
                              """)
        else:
    ...
    def openChatDialog(self):
        ...
        chat_dialog.exec()  # 使用模态对话框，也可以用 chat_dialog.show() 实现非模态显示
